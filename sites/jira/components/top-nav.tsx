  ...
  return (
    <>
      <div className="relative" ref={ref}>
        ...
        {open && (
          <div className="absolute top-full right-0 z-50 mt-2 max-h-[80vh] w-[380px] overflow-y-auto rounded-lg border bg-popover shadow-xl">
            <div className="p-4">
              {/* Header */}
              ...
              <div className="flex flex-col gap-0.5">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-medium">Jira settings</p>
                    <p className="text-xs text-muted-foreground">
                      General configuration, security, automation
                    </p>
                  </div>
                </Link>
                <button
                    ...
                    <div className="flex items-center gap-1">
                      {sc.keys.map((k, i) =>
                        k === "then" ? (
                          <span
                            key={i}
                            className="mx-0.5 text-xs text-muted-foreground"
                          >
                            then
                          </span>
                        ) : (
...
function SettingsItem({
  ...
  if (href) {
    return (
      <Link
        href={href}
        className="flex w-full items-start gap-3 rounded-md px-2 py-2.5 text-left transition-colors hover:bg-accent"
      >
        {content}
      </Link>
    )
  ...
  return (
    <button className="flex w-full items-start gap-3 rounded-md px-2 py-2.5 text-left transition-colors hover:bg-accent">
      {content}
    </button>
  )
}
        ...
        <SheetContent side="right" className="flex flex-col sm:max-w-sm">
          ...
          <div className="flex-1 overflow-y-auto px-2">
            <div className="flex flex-col gap-0.5">
              {helpLinks.map((link) => {
                const cls =
                  "flex items-center gap-3 rounded-md px-3 py-2.5 text-left text-sm hover:bg-accent transition-colors w-full"
                const children = (
                  <>
    ...
    <nav className="hidden items-center gap-0.5 md:flex">
      ...
      <NavDropdown label="Filters">
        <div className="py-1">
          ...
          <Link
            href="/filters/reported-by-me"
            className="flex items-center gap-3 px-3 py-2 text-sm transition-colors hover:bg-accent"
          >
            Reported by me
          </Link>
          <Link
            href="/filters/all-work-items"
            className="flex items-center gap-3 px-3 py-2 text-sm transition-colors hover:bg-accent"
          >
            All work items
          </Link>
      ...
      <NavDropdown label="Plans">
        ...
        <div className="border-t px-3 py-2">
          <Link href="/plans" className="text-xs text-blue-600 hover:underline">
            Create plan
          </Link>
        </div>
      </NavDropdown>
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute top-full right-0 z-50 mt-2 w-56 rounded-lg border bg-popover py-1 shadow-lg">
            {themeSubOpen ? (
              <>
                <button
                  onClick={() => setThemeSubOpen(false)}
              ...
              <>
                {[
                  {
                    ...
                    action: () => router.push("/home/notifications"),
                  },
                  {
                    label: "Help",
                    icon: (
                ...
                >
                  <Avatar className="size-5">
                    <AvatarFallback className="bg-blue-600 text-[8px] font-semibold text-white">
                      AS
                    </AvatarFallback>
                  </Avatar>
                  Profile
    ...
    <>
      ...
      >
        <PopoverTrigger
          ...
          title="Account menu"
        >
          <Avatar className="size-8 cursor-pointer transition-all hover:ring-2 hover:ring-white/50 hover:ring-offset-1 hover:ring-offset-[#0052CC]">
