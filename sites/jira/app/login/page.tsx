    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 w-[400px] rounded-lg bg-white px-10 py-10 shadow-[0_0_10px_rgba(0,0,0,0.1)]">
        ...
        <div className="space-y-3">
          <Button variant="outline" className="w-full gap-2 rounded-[3px] border-slate-200 text-sm font-medium text-slate-800 hover:bg-slate-50" onClick={() => router.push("/")}>
        ...
        <div className="mt-6 text-center">
          <Link href="/switch-account" className="text-sm text-[#0052CC] hover:underline">
        ...
        <div className="mt-8 border-t border-slate-200 pt-6">
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold tracking-wide text-slate-400">ATLASSIAN</span>
            </div>
