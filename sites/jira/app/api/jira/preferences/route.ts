...
export async function GET() {
  if (!BASE || !EMAIL || !TOKEN) {
    return NextResponse.json({ language: "en_US", timezone: "Asia/Kolkata", watchOwn: true })
  }
