...
export default function AccountSettingsPage() {
  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <div className="rounded-lg border p-4">
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-green-50 px-2.5 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/20 dark:text-green-400">Verified</span>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-lg border p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Create and manage API tokens for third-party integrations.</p>
            </div>
      ...
      {/* Connected accounts */}
      <section className="mb-10">
        <h2 className="text-base font-semibold mb-2">Connected accounts</h2>
        <p className="text-sm text-muted-foreground mb-4">
      ...
      {/* Delete account */}
      <section>
        <h2 className="text-base font-semibold mb-2 text-red-600">Delete account</h2>
        <p className="text-sm text-muted-foreground mb-4">
          Permanently delete your account and all associated data. This action cannot be undone.
        </p>
        <Button variant="outline" className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700 dark:border-red-800 dark:hover:bg-red-950/20">
          Delete your account
        </Button>
      </section>
    </div>
