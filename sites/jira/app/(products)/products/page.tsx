...
const recommendedProducts = [
  {
    ...
    description: "Unite teams on a single AI-powered platform to deliver service at scale.",
    icon: (
...
const collections = [
  ...
  },
  {
    ...
    products: "Jira Service Management \u00b7 Customer Service Management \u00b7 Assets",
    cta: "Try now",
  },
  {
    name: "Software",
    ...
    products: "Rovo Dev \u00b7 DX \u00b7 Pipelines \u00b7 Bitbucket \u00b7 Compass",
    cta: "Contact sales",
  },
]
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-[#f0f4ff] via-[#e8f0fe] to-[#dfe8f7]">
          <div className="mx-auto flex max-w-[1200px] items-center px-8 py-16">
            <div className="max-w-lg">
              <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-[#6B778C]">
                Featured App &middot; Confluence
              </p>
              <h1 className="mb-4 text-4xl font-bold leading-tight text-[#253858]">
                Go from ideas to outcomes with Confluence
              </h1>
              <p className="mb-8 text-base leading-relaxed text-[#42526E]">
                Create and organize work documents in one AI-powered workspace to unlock knowledge and collaborate with clarity.
              </p>
            ...
            <div className="relative ml-auto hidden w-[500px] lg:block">
              <div className="relative h-[340px]">
                {/* Background shape */}
                <div className="absolute right-0 top-4 h-72 w-80 rounded-2xl bg-[#c9d8f0] opacity-40" />

                {/* Card 1 - top right */}
                <div className="absolute right-8 top-0 z-10 w-64 rounded-lg border border-[#dfe1e6] bg-white p-3 shadow-lg">
                  <div className="flex items-center gap-2 text-xs">
                    <div className="size-2 rounded-full bg-green-500" />
                    <span className="text-[#0052CC]">Set up a quarterly town hall event</span>
                  </div>
                  <div className="mt-1 flex items-center gap-2 text-[10px] text-[#6B778C]">
                    <span className="rounded bg-[#0052CC] px-1.5 py-0.5 text-[9px] font-bold text-white">IN PROGRESS</span>
                  </div>
                  ...
                  <div className="mt-1 flex items-center gap-3 text-[10px] text-[#6B778C]">
                    ...
                    <span className="flex items-center gap-0.5">
                      <svg className="size-3" viewBox="0 0 32 32" fill="#2684FF"><path d="M27.545 15.2L16.8 4.454 16 3.654l-8.345 8.346-.855.854L4.454 15.2a1.547 1.547 0 000 2.189L12.2 25.135 16 28.935l8.345-8.346.354-.354 2.846-2.846a1.547 1.547 0 000-2.189zM16 20.6l-4.254-4.254L16 12.092l4.254 4.254L16 20.6z" /></svg>
                      Jira
                    </span>
                ...
                {/* Card 2 - sticky note */}
                <div className="absolute left-8 top-16 z-10 w-44 rounded-lg bg-purple-100 p-3 shadow-md">
                  <p className="text-xs font-medium text-[#253858]">Async weekly team kick-offs and stand-ups</p>
                </div>

                {/* Card 3 - pink card */}
                <div className="absolute bottom-16 left-1/3 z-10 rounded-lg bg-pink-100 p-3 shadow-md">
                  <p className="text-xs font-medium text-[#253858]">Regular team activities and team building</p>
                  <div className="mt-2 flex items-center gap-1">
                    <div className="rounded-full bg-[#0052CC] px-2 py-0.5 text-[10px] font-medium text-white">Matthew</div>
                  </div>
                </div>

                {/* Thumbs up badge */}
                <div className="absolute left-1/2 top-1/2 z-20 flex items-center gap-1 rounded-full bg-white px-2 py-1 shadow-md">
                  <span className="text-sm">👍</span>
                  <span className="text-xs font-medium text-[#253858]">3</span>
                </div>

                {/* Ask Rovo badge */}
                <div className="absolute bottom-32 right-4 z-20 rounded-full border border-[#dfe1e6] bg-white px-3 py-1.5 shadow-sm">
                  <span className="text-xs font-medium text-[#42526E]">Ask Rovo</span>
                </div>

                {/* Bottom yellow curve */}
                <div className="absolute -bottom-4 right-0 h-24 w-64 rounded-tl-[100px] bg-[#F5A623] opacity-70" />
        ...
        <section className="py-16">
          <div className="mx-auto max-w-[1200px] px-8">
            ...
            {/* Recommended */}
            <div className="mb-16">
              <h3 className="mb-1 text-xl font-bold text-[#253858]">Recommended</h3>
              <p className="mb-6 text-sm text-[#42526E]">Top apps to kickstart your productivity</p>
                ...
                {recommendedProducts.map((product) => (
                  ...
                  >
                    <div className="mb-4 flex items-center gap-3">
                      {product.icon}
                      <h4 className="text-lg font-bold text-[#253858]">{product.name}</h4>
                    </div>
            ...
            {/* Collections */}
            <div>
              <h3 className="mb-1 text-xl font-bold text-[#253858]">Collections</h3>
