...
export default function PlansPage() {
  ...
  const handleCreate = async () => {
    ...
    const workSources = spaceName.trim()
      ? [{ type: workType as "space" | "board" | "filter", name: spaceName.trim() }]
      : []
  ...
  if (showCreate) {
    return (
      <div className="fixed inset-0 z-50 flex bg-blue-50/40 dark:bg-background">
        {/* Left form panel */}
        <div className="flex w-full max-w-xl flex-col bg-card px-12 py-8 overflow-y-auto">
          {/* Close */}
          <button
          ...
          <div className="mb-6 flex items-center gap-2">
            <svg className="size-7" viewBox="0 0 32 32" fill="none">
              <defs>
                <linearGradient id="jira-plan-logo" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stopColor="#2684FF" />
                  <stop offset="100%" stopColor="#0052CC" />
                </linearGradient>
              </defs>
              <path d="M27.545 15.2L16.8 4.454 16 3.654l-8.345 8.346-.855.854L4.454 15.2a1.547 1.547 0 000 2.189L12.2 25.135 16 28.935l8.345-8.346.354-.354 2.846-2.846a1.547 1.547 0 000-2.189zM16 20.6l-4.254-4.254L16 12.092l4.254 4.254L16 20.6z" fill="url(#jira-plan-logo)" />
            </svg>
          ...
          <p className="mb-8 text-sm text-muted-foreground leading-relaxed">
            Visualize, plan, track, and report on work across multiple spaces, boards or teams.
          </p>
          ...
          <div className="mb-6">
            ...
            <select
              value={access}
              onChange={(e) => setAccess(e.target.value as "open" | "private" | "team")}
          ...
          <div className="mb-2">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="h-10 w-36 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
              >
        ...
        <div className="hidden flex-1 items-center justify-center lg:flex">
          <div className="w-[560px] rounded-xl bg-card p-6 shadow-xl">
            ...
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <svg className="h-3 w-28" viewBox="0 0 112 12">
                  <path d="M0,6 Q14,1 28,6 T56,6 T84,6 T112,6" fill="none" stroke="currentColor" strokeWidth="2" className="text-foreground" />
                </svg>
              </div>
            ...
            <div className="mb-4 flex gap-4 border-b text-sm">
              ...
              <span className="border-b-2 border-foreground pb-2 font-medium">Timeline</span>
            ...
            <div className="relative flex flex-col gap-0">
              ...
              {/* Group 1 rows */}
              {[
                { color: "bg-[#6B8E23]", width: "w-[180px]", offset: "ml-[60px]" },
                { color: "bg-[#6B8E23]", width: "w-[170px]", offset: "ml-[70px]" },
                { color: "bg-purple-500", width: "w-[60px]", offset: "ml-[140px]" },
                { color: "bg-[#556B2F]", width: "w-[130px]", offset: "ml-[160px]" },
              ].map((bar, i) => (
                <div key={`g1-${i}`} className="flex items-center gap-2 py-[5px]">
                  ...
                  <div className={`h-[18px] rounded-sm ${bar.color} ${bar.width} ${bar.offset}`} />
                </div>
              ))}

              {/* Dependency line between purple bar (row 3) and green bar (row 4) */}
              <svg className="pointer-events-none absolute" style={{ top: "188px", left: "280px", width: "60px", height: "32px" }}>
                <path d="M0,0 L0,16 Q0,24 8,24 L52,24" fill="none" stroke="#94a3b8" strokeWidth="1.5" />
              </svg>
              ...
              {/* Group 2 rows */}
              {[
                { color: "bg-blue-500", width: "w-[210px]", offset: "ml-[60px]" },
                { color: "bg-pink-500", width: "w-[80px]", offset: "ml-[120px]" },
                { color: "bg-blue-400", width: "w-[120px]", offset: "ml-[160px]" },
              ].map((bar, i) => (
                <div key={`g2-${i}`} className="flex items-center gap-2 py-[5px]">
                  <div className="h-2 w-2 rounded-sm bg-muted" />
                  <div className="h-3 w-[90px] rounded bg-muted" />
                  <div className="size-5 rounded-full bg-muted/80" />
                  <div className={`h-[18px] rounded-sm ${bar.color} ${bar.width} ${bar.offset}`} />
              ...
              <svg className="pointer-events-none absolute" style={{ top: "308px", left: "280px", width: "60px", height: "32px" }}>
                <path d="M0,0 L0,16 Q0,24 8,24 L52,24" fill="none" stroke="#94a3b8" strokeWidth="1.5" />
              </svg>
              ...
              {/* Group 3 rows */}
              {[
                { color: "bg-[#6B8E23]", width: "w-[150px]", offset: "ml-[120px]" },
                { color: "bg-blue-500", width: "w-[180px]", offset: "ml-[100px]" },
                { color: "bg-pink-500", width: "w-[160px]", offset: "ml-[140px]" },
              ].map((bar, i) => (
                <div key={`g3-${i}`} className="flex items-center gap-2 py-[5px]">
                  <div className="h-2 w-2 rounded-sm bg-muted" />
                  <div className="h-3 w-[90px] rounded bg-muted" />
                  <div className="size-5 rounded-full bg-muted/80" />
                  <div className={`h-[18px] rounded-sm ${bar.color} ${bar.width} ${bar.offset}`} />
      ...
      <div className="p-8">
        ...
        <div className="flex flex-col items-center justify-center py-24">
          <svg className="mb-6 size-40" viewBox="0 0 200 200" fill="none">
            <rect x="40" y="40" width="120" height="100" rx="8" fill="#DBEAFE" />
            ...
            <polyline points="55,95 75,80 100,88 120,70 145,60" stroke="#2563EB" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <polyline points="149,45 153,49 161,41" stroke="white" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <rect x="133" y="157" width="14" height="18" rx="7" fill="#3B82F6" />
          </svg>
