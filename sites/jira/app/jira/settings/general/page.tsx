...
function SettingRow({ label, description, children }: { label: string; description: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 28, paddingBottom: 28, borderBottom: "1px solid #F4F5F7" }}>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 24 }}>
        <div style={{ flex: 1 }}>
          <p style={{ fontSize: 14, fontWeight: 500, color: "#172B4D", marginBottom: 4 }}>{label}</p>
          <p style={{ fontSize: 13, color: "#6B778C", lineHeight: 1.5 }}>{description}</p>
        </div>
  ...
  return (
    <Link
      ...
      style={{
        ...
        borderRadius: 3, textDecoration: "none", marginBottom: 2,
      }}
...
export default function GeneralSettingsPage() {
  ...
  const timezones = typeof Intl !== "undefined" && (Intl as any).supportedValuesOf
    ...
    : ["Asia/Kolkata", "America/New_York", "America/Los_Angeles", "Europe/London", "Europe/Paris", "Asia/Tokyo"]
  ...
  return (
    <div style={{ display: "flex", padding: "32px 40px", gap: 0, minHeight: "100vh", background: "white" }}>
      ...
      <div style={{ flex: 1, maxWidth: 600 }}>
        <h1 style={{ fontSize: 24, fontWeight: 500, color: "#172B4D", marginBottom: 32, marginTop: 0 }}>
          General settings
        </h1>
