...
export default function BackupAndRestorePage() {
    ...
    const topics = [
      {
        ...
        description: "An overview of what Atlassian backups are and our data retention policies",
      },
      {
        title: "Understand billing for Atlassian Backup and Restore",
        description: "Learn who can purchase Atlassian Backup and Restore, the applicable limits, and how billing works.",
      },
      {
        title: "What data is backed up and restored",
        description: "View what app data types are included in our backups and restores.",
      },
      {
        title: "What is a backup policy",
        description: "Read how you can create backup policies, run, or edit backups",
      },
      {
        title: "Restore app data from backup",
        description: "Read about the different ways in which you can restore backups",
      },
      {
        title: "Customer-managed key encryption for backups",
        description: "Know how encryption, re-encryption, and revocation of Customer-managed keys affect backups and restores.",
      },
      {
        title: "Backup and restore: Frequently asked questions",
        description: "Find answers to common questions about Atlassian Backup and Restore.",
      },
      {
        title: "Manage backup and restore with sharding",
        description: "Learn how sharding works with backup and restore for large-scale organizations.",
      },
    ]
      ...
      <div className="fixed inset-0 z-50 bg-background overflow-y-auto">
        ...
        <div className="border-b bg-[#0052CC]">
          <div className="max-w-5xl mx-auto px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-8">
              ...
              <span className="text-white/70 text-sm">Documentation</span>
        ...
        <div className="max-w-5xl mx-auto px-8 pt-8 pb-16">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            <button onClick={() => setShowBenefits(false)} className="hover:text-foreground">
              Atlassian Support
            </button>
            <span>/</span>
          ...
          <h1 className="text-2xl font-bold mb-8">Backup and restore Atlassian app data</h1>

          <div className="grid grid-cols-2 gap-4">
            {topics.map((topic) => (
              <div
                key={topic.title}
                className="rounded-lg border p-6 hover:bg-muted/30 transition-colors"
              >
  ...
  const resetContactForm = () => {
    setContactForm({ email: "", firstName: "", lastName: "", company: "", jobTitle: "", product: "", message: "" })
    setSubmitted(false)
  ...
  if (showContactForm) {
    return (
      <div className="fixed inset-0 z-50 bg-background overflow-y-auto">
          ...
          <div className="max-w-6xl mx-auto px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-8">
              <svg className="size-8" viewBox="0 0 32 32" fill="none">
                <path d="M16 2L6 8v8c0 7.5 4.3 14.5 10 16 5.7-1.5 10-8.5 10-16V8L16 2z" fill="#1868DB" />
                <path d="M16 6l-6 3.5v5c0 4.7 2.7 9.1 6 10 3.3-.9 6-5.3 6-10v-5L16 6z" fill="white" />
              </svg>
        ...
        {submitted ? (
          <div className="max-w-xl mx-auto px-8 pt-20 pb-16 text-center">
            ...
            <h2 className="text-2xl font-bold mb-3">Thank you for contacting us!</h2>
            <p className="text-muted-foreground mb-6">
              Our sales team will review your request and get back to you within 1 business day.
            </p>
            <Button
              variant="outline"
              onClick={() => { setShowContactForm(false); resetContactForm() }}
            ...
            <div className="grid grid-cols-3 gap-12">
              ...
              <div className="col-span-2">
                ...
                <div className="flex items-baseline gap-3 mb-2">
                  <h1 className="text-2xl font-bold">I&apos;d like to discuss</h1>
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() => setTopicDropdownOpen(!topicDropdownOpen)}
                      className="flex items-center gap-2 text-2xl font-bold text-blue-600 border-b-2 border-blue-600 pb-0.5"
                    >
                      {discussTopic}
                    ...
                    {topicDropdownOpen && (
                      <>
                        ...
                        <div className="absolute left-0 top-10 z-50 w-64 rounded-md border bg-popover shadow-md">
                          {DISCUSS_TOPICS.map((topic) => (
                            <button
                              ...
                              onClick={() => { setDiscussTopic(topic); setTopicDropdownOpen(false) }}
                            >
                              {topic}
                            </button>
                          ))}
                ...
                <p className="text-muted-foreground mb-8">
                  Get a quote or ask pricing questions about a product or service you might purchase.
                </p>
                ...
                <div className="space-y-5 max-w-lg">
                  <div>
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">Personal email domains will result in an error.</p>
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-1.5">
                      Which product or service are you inquiring about? <span className="text-red-500">*</span>
                    </label>
                    <select
                    ...
                    <p className="text-xs text-muted-foreground mt-1">If you&apos;re asking about multiple products, select the one with the most users.</p>
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (!contactForm.email.trim() || !contactForm.firstName.trim() || !contactForm.lastName.trim() || !contactForm.company.trim() || !contactForm.jobTitle.trim() || !contactForm.product) return
                        setSubmitted(true)
                      }}
                    >
                      Submit
              ...
              <div className="space-y-4">
                <div className="rounded-lg border p-5">
                  <h3 className="text-base font-bold mb-2">Cloud pricing calculator</h3>
                ...
                <div className="rounded-lg border p-5">
                  <h3 className="text-base font-bold mb-2">Cloud value calculator</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Compare the total cost of your server products to Cloud.
                  </p>
                  <Button variant="outline" size="sm">Compare costs</Button>
                </div>

                <div className="rounded-lg border p-5">
                  <h3 className="text-base font-bold mb-2">Data Center comparison</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    See what it would cost to upgrade your server SENs to Data Center.
                  </p>
