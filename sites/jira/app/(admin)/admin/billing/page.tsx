    ...
    <div className="p-8 max-w-5xl">
            ...
            {apps.map((app) => (
              <tr key={app.name} className="border-b last:border-b-0 hover:bg-accent/30 transition-colors">
                ...
                <td className="px-4 py-3 text-sm">
                  {app.usersLink ? (
                    <button type="button" className="text-blue-600 hover:underline">{app.users}</button>
                  ) : (
                    app.users
                  )}
                </td>
      ...
      <div className="flex items-center gap-8 mt-4">
        <div className="flex items-center gap-2">
          ...
          <button type="button" className="text-sm text-blue-600 hover:underline inline-flex items-center gap-0.5">
            Visit Bitbucket
