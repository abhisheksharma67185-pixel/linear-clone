...
export default function LicensingPage() {
  return (
    <div className="p-8 max-w-5xl">
      <h1 className="text-2xl font-semibold mb-2">Licensing</h1>
      <p className="text-sm text-muted-foreground mb-8">Server and Data Center licensing</p>

      <div className="rounded-lg border p-6 mb-6">
        <h2 className="text-base font-semibold mb-4">Active licenses</h2>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="py-4"><span className="inline-flex items-center rounded-full bg-green-50 px-2.5 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/20 dark:text-green-400">Active</span></td>
              </tr>
              <tr>
                <td className="py-4">
                  <div className="flex items-center gap-3">
                    <div className="flex size-8 items-center justify-center rounded bg-gradient-to-br from-blue-400 to-purple-600">
                      <svg aria-hidden="true" className="size-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>
                    </div>
      ...
      <div className="rounded-lg border p-6">
        <h2 className="text-base font-semibold mb-2">Need more licenses?</h2>
