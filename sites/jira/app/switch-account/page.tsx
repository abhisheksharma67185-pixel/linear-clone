    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white">
      ...
      <div className="absolute bottom-0 left-0 h-[320px] w-[300px]">
        <svg viewBox="0 0 300 320" fill="none" className="h-full w-full">
          ...
          {/* Chart board */}
          <rect x="30" y="100" width="80" height="100" rx="6" fill="white" stroke="#E0E0E0" strokeWidth="2" />
      ...
      <div className="absolute bottom-0 right-0 h-[320px] w-[300px]">
        <svg viewBox="0 0 300 320" fill="none" className="h-full w-full">
          {/* Magnifying glass */}
          <circle cx="220" cy="120" r="40" stroke="#1868DB" strokeWidth="6" fill="none" />
          <line x1="248" y1="148" x2="270" y2="170" stroke="#FF7043" strokeWidth="8" strokeLinecap="round" />
          {/* Documents */}
          <rect x="100" y="160" width="70" height="90" rx="6" fill="white" stroke="#E0E0E0" strokeWidth="2" />
          ...
          <line x1="230" y1="170" x2="250" y2="140" stroke="#FFA726" strokeWidth="4" strokeLinecap="round" />
        </svg>
      </div>
      ...
      <div className="relative z-10 w-[400px] rounded-lg bg-white px-10 py-10 shadow-[0_0_10px_rgba(0,0,0,0.1)]">
        ...
        <div className="mb-8 flex items-center justify-center gap-3">
          ...
          <span className="text-xl font-bold tracking-wide text-[#1868DB]">ATLASSIAN</span>
        </div>
        ...
        <Link
          href="/"
          className="flex items-center gap-3 border-b border-[#dfe1e6] py-4 hover:bg-[#f4f5f7] transition-colors -mx-3 px-3 rounded"
        >
          <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-[#0052CC] text-xs font-bold text-white">
            AS
          </div>
          <div>
            <p className="text-sm font-semibold text-[#253858]">Abhishek Sharma</p>
            <p className="text-sm text-[#6B778C]">abhisheksharma67185@gmail.com</p>
          </div>
        </Link>
        ...
        >
          <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-[#DFE1E6]">
            <svg className="size-5 text-[#6B778C]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-4 border-b border-[#dfe1e6] pb-4 text-center">
          <Link href="/login" className="text-sm font-medium text-[#0052CC] hover:underline">
            Log out
          </Link>
        </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold tracking-wide text-[#B3BAC5]">ATLASSIAN</span>
          </div>
