...
const sidebarItems = [
  ...
  { name: "Status updates", href: "/project-directory/status-updates", icon: "activity" },
...
export default function ProjectDirectoryLayout({ children }: { children: React.ReactNode }) {
