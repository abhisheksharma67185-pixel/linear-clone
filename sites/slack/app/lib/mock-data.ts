...
export const channels: Channel[] = [
  {
    ...
    purpose:
      "This channel is for team-wide communication and announcements. All team members are included.",
    type: "public",
    isGeneral: true,
    isArchived: false,
    isShared: false,
  ...
  },
  {
    ...
    purpose:
      "A place for non-work-related flimflam, faffing, hodge-podge or jibber-jabber.",
    type: "public",
    isGeneral: false,
    isArchived: false,
    isShared: false,
...
export const messages: Message[] = [
  ...
  mkMsg("msg-1", {
    channelId: "ch-1",
    authorId: "usr-slackbot",
    text: "Welcome to Theta HQ! Please introduce yourself in #general.",
    createdAt: "2024-01-10T09:00:00.000Z",
  }),
  mkMsg("msg-2", {
    channelId: "ch-1",
    authorId: "usr-1",
    text: "Good morning everyone — welcome to our new Slack workspace!",
    createdAt: "2024-01-10T09:05:00.000Z",
  }),
  mkMsg("msg-3", {
    channelId: "ch-1",
    authorId: "usr-1",
    text: "Pinned: Our company all-hands happens every Tuesday at 10am IST. Calendar invite in #announcements.",
    createdAt: "2024-01-12T10:00:00.000Z",
    pinnedBy: "usr-1",
    reactions: [{ emoji: ":pushpin:", userIds: ["usr-2", "usr-4"] }],
  }),
  mkMsg("msg-4", {
    channelId: "ch-1",
    authorId: "usr-2",
    text: "New coffee machine on the 4th floor is live :coffee:",
    createdAt: "2026-04-12T09:00:00.000Z",
    reactions: [{ emoji: ":tada:", userIds: ["usr-3", "usr-4", "usr-5"] }],
  }),
  mkMsg("msg-5", {
    channelId: "ch-1",
    authorId: "usr-8",
    text: "Reminder: Q2 planning doc due by Friday. Link in #product.",
    createdAt: "2026-04-12T10:30:00.000Z",
  }),
  mkMsg("msg-6", {
    channelId: "ch-1",
    authorId: "usr-4",
    text: "Design system v2 is live! Check out the new components.",
    createdAt: "2026-04-12T11:00:00.000Z",
    reactions: [{ emoji: ":fire:", userIds: ["usr-1", "usr-5", "usr-10"] }],
  }),
  mkMsg("msg-7", {
    channelId: "ch-1",
    authorId: "usr-1",
    text: "Pinned: Onboarding canvas for new joiners is attached to this channel.",
  ...
  mkMsg("msg-8", {
    channelId: "ch-1",
    authorId: "usr-7",
    text: "Interview panels next week — please confirm availability in #hiring.",
    createdAt: "2026-04-13T08:00:00.000Z",
  }),
  mkMsg("msg-9", {
    channelId: "ch-1",
    authorId: "usr-6",
    text: "Team lunch tomorrow at 1pm, 3rd floor kitchen.",
    createdAt: "2026-04-13T08:30:00.000Z",
    reactions: [{ emoji: ":pizza:", userIds: ["usr-2", "usr-5", "usr-8"] }],
  }),
  mkMsg("msg-10", {
    channelId: "ch-1",
    authorId: "usr-11",
    text: "Security training reminder — please complete by end of week.",
    mentions: ["usr-slackbot"],
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-11", {
    channelId: "ch-1",
    authorId: "usr-14",
    text: "Prod deploy window shifted to 3pm IST today.",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  mkMsg("msg-12", {
    channelId: "ch-1",
    authorId: "usr-1",
    text: "Welcome to the new hires joining this week! Please say hi.",
    createdAt: "2026-04-13T10:00:00.000Z",
    reactions: [
      {
        emoji: ":wave:",
        userIds: ["usr-2", "usr-4", "usr-6", "usr-8", "usr-11"],
      },
    ],
  }),
  mkMsg("msg-13", {
    channelId: "ch-1",
    authorId: "usr-13",
    text: "New vendor NDA template available in #legal-team.",
    createdAt: "2026-04-13T10:15:00.000Z",
  }),
  mkMsg("msg-14", {
    channelId: "ch-1",
    authorId: "usr-2",
    text: "FYI engineering all-hands postponed to next Thursday.",
  ...
  mkMsg("msg-15", {
    channelId: "ch-2",
    authorId: "usr-5",
    text: "Anyone tried the new ramen place next to the office?",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-16", {
    channelId: "ch-2",
    authorId: "usr-8",
    text: "Yes! The tonkotsu is amazing.",
    createdAt: "2026-04-13T09:05:00.000Z",
    reactions: [{ emoji: ":ramen:", userIds: ["usr-5", "usr-6"] }],
  }),
  mkMsg("msg-17", {
    channelId: "ch-2",
    authorId: "usr-6",
    text: "Meme of the day :laughing:",
    createdAt: "2026-04-13T09:10:00.000Z",
  }),
  mkMsg("msg-18", {
    channelId: "ch-2",
    authorId: "usr-3",
    text: "Who's joining Friday coffee chat?",
    createdAt: "2026-04-13T09:15:00.000Z",
    reactions: [
      { emoji: ":raised_hand:", userIds: ["usr-1", "usr-5", "usr-8"] },
    ],
  }),
  mkMsg("msg-19", {
    channelId: "ch-2",
    authorId: "usr-10",
    text: "Just finished my first marathon :running:",
    createdAt: "2026-04-13T09:20:00.000Z",
    reactions: [
      {
        emoji: ":tada:",
        userIds: ["usr-1", "usr-2", "usr-4", "usr-6", "usr-8"],
      },
      { emoji: ":fire:", userIds: ["usr-3", "usr-5"] },
    ],
  }),
  mkMsg("msg-20", {
    channelId: "ch-2",
    authorId: "usr-12",
    text: "TIL clickhouse has arrays as first-class types",
    createdAt: "2026-04-13T09:25:00.000Z",
  }),
  mkMsg("msg-21", {
    channelId: "ch-2",
    authorId: "usr-4",
    text: "New office plant arrived :herb:",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  mkMsg("msg-22", {
    channelId: "ch-2",
    authorId: "usr-9",
    text: "Anyone up for lunch at noon?",
    createdAt: "2026-04-13T09:35:00.000Z",
  }),
  mkMsg("msg-23", {
    channelId: "ch-2",
    authorId: "usr-11",
    text: "Dog photos thread below :dog:",
    createdAt: "2026-04-13T09:40:00.000Z",
  }),
  mkMsg("msg-24", {
    channelId: "ch-2",
    authorId: "usr-15",
    text: "Team karaoke Friday anyone?",
  ...
  mkMsg("msg-25", {
    channelId: "ch-3",
    authorId: "usr-1",
    text: "Q1 results are in — we exceeded our targets! Great work everyone.",
  ...
  mkMsg("msg-26", {
    channelId: "ch-3",
    authorId: "usr-7",
    text: "New office space confirmed for Bangalore — move-in June 1st.",
    createdAt: "2026-04-05T10:00:00.000Z",
  }),
  mkMsg("msg-27", {
    channelId: "ch-3",
    authorId: "usr-1",
    text: "Annual performance reviews begin next Monday.",
    createdAt: "2026-04-08T10:00:00.000Z",
  }),
  mkMsg("msg-28", {
    channelId: "ch-3",
    authorId: "usr-2",
    text: "Reminder: company holiday on Friday April 17th.",
    createdAt: "2026-04-10T10:00:00.000Z",
  }),
  mkMsg("msg-29", {
    channelId: "ch-3",
    authorId: "usr-4",
    text: "New brand guidelines coming this week — watch for updates.",
    createdAt: "2026-04-11T10:00:00.000Z",
  }),
  mkMsg("msg-30", {
    channelId: "ch-3",
    authorId: "usr-7",
    text: "Engineering hiring for 5 senior roles — refer your network.",
  ...
  mkMsg("msg-31", {
    channelId: "ch-4",
    authorId: "usr-2",
    text: "PR for PLT-101 (OAuth2 PKCE flow) merged to main.",
    createdAt: "2026-04-11T09:00:00.000Z",
    reactions: [{ emoji: ":white_check_mark:", userIds: ["usr-1", "usr-3"] }],
  }),
  mkMsg("msg-32", {
    channelId: "ch-4",
    authorId: "usr-3",
    text: "PR for PLT-102 refresh token rotation ready for review.",
  ...
  mkMsg("msg-33", {
    channelId: "ch-4",
    authorId: "usr-1",
    text: "LGTM on PLT-102, merging now.",
    createdAt: "2026-04-11T10:30:00.000Z",
  }),
  mkMsg("msg-34", {
    channelId: "ch-4",
    authorId: "usr-2",
    text: "Working on PLT-104 rate limiting today. Token-bucket approach.",
    createdAt: "2026-04-12T09:00:00.000Z",
  }),
  mkMsg("msg-35", {
    channelId: "ch-4",
    authorId: "usr-5",
    text: "Frontend staging env deployed with new auth flow.",
    createdAt: "2026-04-12T09:30:00.000Z",
  }),
  mkMsg("msg-36", {
    channelId: "ch-4",
    authorId: "usr-11",
    text: "Security review scheduled for Thursday 2pm.",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-37", {
    channelId: "ch-4",
    authorId: "usr-14",
    text: "Prod db migration completed, 2.4M rows updated.",
    createdAt: "2026-04-12T10:30:00.000Z",
    reactions: [{ emoji: ":fire:", userIds: ["usr-1", "usr-2", "usr-9"] }],
  }),
  mkMsg("msg-38", {
    channelId: "ch-4",
    authorId: "usr-9",
    text: "Cluster upgrade to 1.29 complete, zero downtime.",
    createdAt: "2026-04-12T11:00:00.000Z",
    reactions: [
      { emoji: ":rocket:", userIds: ["usr-1", "usr-2", "usr-3", "usr-14"] },
    ],
  }),
  mkMsg("msg-39", {
    channelId: "ch-4",
    authorId: "usr-12",
    text: "Analytics pipeline backfill done for last 6 months.",
    createdAt: "2026-04-12T11:30:00.000Z",
  }),
  mkMsg("msg-40", {
    channelId: "ch-4",
    authorId: "usr-15",
    text: "QA regression suite down to 12 min runtime :raised_hands:",
    createdAt: "2026-04-12T12:00:00.000Z",
    reactions: [{ emoji: ":raised_hands:", userIds: ["usr-1", "usr-5"] }],
  }),
  mkMsg("msg-41", {
    channelId: "ch-4",
    authorId: "usr-1",
    text: "Pinned runbook: https://runbooks.theta.internal/oncall",
  ...
  mkMsg("msg-42", {
    channelId: "ch-4",
    authorId: "usr-2",
    text: "Who's on call this week? I need a pair for a quick debug.",
    mentions: ["usr-3"],
  ...
  mkMsg("msg-44", {
    ...
    reactions: [
      {
        emoji: ":+1:",
        userIds: ["usr-2", "usr-3", "usr-5", "usr-9", "usr-14"],
      },
      { emoji: ":rocket:", userIds: ["usr-2", "usr-3", "usr-11"] },
      { emoji: ":tada:", userIds: ["usr-5", "usr-15"] },
    ],
  }),
  mkMsg("msg-45", {
    channelId: "ch-4",
    authorId: "usr-5",
    text: "Error rate dropped 40% after the rate-limit fix. Great work @arjun.",
    mentions: ["usr-2"],
    createdAt: "2026-04-13T08:30:00.000Z",
  }),
  mkMsg("msg-46", {
    channelId: "ch-4",
    authorId: "usr-7",
    text: "Sprint review Friday at 2pm, please come prepared.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-47", {
    channelId: "ch-4",
    authorId: "usr-11",
    text: "CVE scan clean, all dependencies up-to-date.",
    createdAt: "2026-04-13T09:30:00.000Z",
    reactions: [{ emoji: ":shield:", userIds: ["usr-1"] }],
  }),
  mkMsg("msg-48", {
    channelId: "ch-4",
    authorId: "usr-2",
    text: "Starting a huddle for the rate-limit debug — join if interested.",
    createdAt: "2026-04-13T10:00:00.000Z",
  }),
  ...
  mkMsg("msg-50", {
    channelId: "ch-4",
    authorId: "usr-5",
    text: "The new auth flow feels so smooth",
    threadRootId: "msg-44",
  ...
  mkMsg("msg-51", {
    channelId: "ch-4",
    authorId: "usr-11",
    text: "Security audit passed with flying colors",
    threadRootId: "msg-44",
  ...
  mkMsg("msg-52", {
    channelId: "ch-4",
    authorId: "usr-2",
    text: "Next up: PLT-103 session mgmt API",
    threadRootId: "msg-44",
  ...
  mkMsg("msg-53", {
    channelId: "ch-5",
    authorId: "usr-4",
    text: "Checkout v3 mockups ready for review — Figma link in bookmarks.",
    createdAt: "2026-04-12T09:00:00.000Z",
  }),
  mkMsg("msg-54", {
    channelId: "ch-5",
    authorId: "usr-6",
    text: "Love the new color palette. Much more accessible.",
    createdAt: "2026-04-12T09:30:00.000Z",
  }),
  mkMsg("msg-55", {
    channelId: "ch-5",
    authorId: "usr-10",
    text: "Icon set updated — 45 new icons added.",
    createdAt: "2026-04-12T10:00:00.000Z",
    reactions: [{ emoji: ":art:", userIds: ["usr-4", "usr-6"] }],
  }),
  mkMsg("msg-56", {
    channelId: "ch-5",
    authorId: "usr-4",
    text: "Design crit session tomorrow 3pm.",
    createdAt: "2026-04-12T11:00:00.000Z",
  }),
  mkMsg("msg-57", {
    channelId: "ch-5",
    authorId: "usr-8",
    text: "Product wants to know ETA on the empty state illustrations.",
    mentions: ["usr-4"],
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-58", {
    channelId: "ch-5",
    authorId: "usr-4",
    text: "By EOD Thursday.",
    createdAt: "2026-04-12T14:05:00.000Z",
  }),
  mkMsg("msg-59", {
    channelId: "ch-5",
    authorId: "usr-6",
    text: "Brand guide v2 canvas attached to this channel.",
    createdAt: "2026-04-12T15:00:00.000Z",
  }),
  mkMsg("msg-60", {
    channelId: "ch-5",
    authorId: "usr-10",
    text: "Dark mode tokens finalized.",
    createdAt: "2026-04-12T15:30:00.000Z",
  }),
  mkMsg("msg-61", {
    channelId: "ch-5",
    authorId: "usr-4",
    text: "Sharing the motion principles doc for review.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-62", {
    channelId: "ch-5",
  ...
  mkMsg("msg-63", {
    channelId: "ch-5",
    authorId: "usr-4",
    text: "Yes 3pm works. Sending invite.",
    createdAt: "2026-04-13T09:35:00.000Z",
  }),
  ...
  mkMsg("msg-64", {
    channelId: "ch-6",
    authorId: "usr-8",
    text: "Q2 OKRs draft ready — feedback welcome.",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-65", {
    channelId: "ch-6",
    authorId: "usr-1",
    text: "Looks solid. One question on KR2.",
    createdAt: "2026-04-12T10:30:00.000Z",
  }),
  mkMsg("msg-66", {
    channelId: "ch-6",
    authorId: "usr-8",
    text: "Roadmap canvas attached to channel.",
    createdAt: "2026-04-12T11:00:00.000Z",
  }),
  mkMsg("msg-67", {
    channelId: "ch-6",
    authorId: "usr-7",
    text: "Engineering committed to 3 of the 5 items.",
    createdAt: "2026-04-12T11:30:00.000Z",
  }),
  mkMsg("msg-68", {
    channelId: "ch-6",
    authorId: "usr-4",
    text: "Design capacity review needed for items 2 and 5.",
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-69", {
    channelId: "ch-6",
    authorId: "usr-8",
    text: "Launch checklist list just created — take a look.",
    createdAt: "2026-04-13T08:00:00.000Z",
  }),
  mkMsg("msg-70", {
    channelId: "ch-6",
    authorId: "usr-2",
    text: "I'll own the platform items, have a draft plan.",
    createdAt: "2026-04-13T08:30:00.000Z",
  }),
  mkMsg("msg-71", {
    channelId: "ch-6",
    authorId: "usr-11",
    text: "Compliance review needed before ship.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-72", {
    channelId: "ch-6",
    authorId: "usr-8",
    text: "On it — syncing with legal this afternoon.",
    createdAt: "2026-04-13T09:15:00.000Z",
  }),
  ...
  mkMsg("msg-73", {
    channelId: "ch-7",
    authorId: "usr-1",
    text: "Daily standup: status updates below please.",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  mkMsg("msg-74", {
    channelId: "ch-7",
    authorId: "usr-2",
    text: "Yesterday: PLT-101 merged. Today: PLT-104 rate limiting. No blockers.",
    createdAt: "2026-04-13T09:31:00.000Z",
  }),
  mkMsg("msg-75", {
    channelId: "ch-7",
    authorId: "usr-3",
    text: "Yesterday: PLT-102 review. Today: PLT-103 session API spec. No blockers.",
    createdAt: "2026-04-13T09:32:00.000Z",
  }),
  mkMsg("msg-76", {
    channelId: "ch-7",
    authorId: "usr-5",
    text: "Yesterday: frontend staging. Today: auth UI polish. No blockers.",
    createdAt: "2026-04-13T09:33:00.000Z",
  }),
  mkMsg("msg-77", {
    channelId: "ch-7",
    authorId: "usr-11",
    text: "Yesterday: CVE scan. Today: security review prep. No blockers.",
    createdAt: "2026-04-13T09:34:00.000Z",
  }),
  mkMsg("msg-78", {
    channelId: "ch-7",
    authorId: "usr-9",
    text: "Yesterday: cluster upgrade. Today: monitoring dashboards. No blockers.",
    createdAt: "2026-04-13T09:35:00.000Z",
  }),
  mkMsg("msg-79", {
    channelId: "ch-7",
    authorId: "usr-14",
    text: "Yesterday: prod migration. Today: backup automation. Blocker: waiting on infra team for storage quota.",
    createdAt: "2026-04-13T09:36:00.000Z",
  }),
  mkMsg("msg-80", {
    channelId: "ch-7",
    authorId: "usr-9",
    text: "Will bump the quota today.",
    createdAt: "2026-04-13T09:37:00.000Z",
  }),
  mkMsg("msg-81", {
    channelId: "ch-7",
    authorId: "usr-1",
    text: "Thanks everyone. Reviews going well, will check in at EOD.",
    createdAt: "2026-04-13T09:40:00.000Z",
  }),
  mkMsg("msg-82", {
    channelId: "ch-7",
    authorId: "usr-2",
    text: "Heads up: rate-limit change needs feature flag first.",
    createdAt: "2026-04-13T10:00:00.000Z",
  }),
  mkMsg("msg-83", {
    channelId: "ch-7",
    authorId: "usr-7",
    text: "Oncall rotation: Ravi → Arjun → Priya next week.",
    createdAt: "2026-04-13T10:15:00.000Z",
  }),
  mkMsg("msg-84", {
    channelId: "ch-7",
    authorId: "usr-15",
    text: "QA coverage at 84% for platform module.",
    createdAt: "2026-04-13T10:30:00.000Z",
  }),
  mkMsg("msg-85", {
    channelId: "ch-7",
    authorId: "usr-3",
    text: "Session API RFC draft: /docs/rfc/session-api-v1",
    createdAt: "2026-04-13T10:45:00.000Z",
  }),
  mkMsg("msg-86", {
    channelId: "ch-7",
    authorId: "usr-5",
    text: "+1 for RFC format.",
    createdAt: "2026-04-13T10:50:00.000Z",
  }),
  mkMsg("msg-87", {
    channelId: "ch-7",
    authorId: "usr-11",
    text: "Security checklist added.",
  ...
  mkMsg("msg-88", {
    channelId: "ch-8",
    authorId: "usr-5",
    text: "Design system v2 integration PR up.",
    createdAt: "2026-04-12T09:00:00.000Z",
  }),
  mkMsg("msg-89", {
    channelId: "ch-8",
  ...
  mkMsg("msg-90", {
    channelId: "ch-8",
    authorId: "usr-10",
    text: "Icon component refactor done.",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-91", {
    channelId: "ch-8",
    authorId: "usr-8",
    text: "PM asking about bundle size.",
    createdAt: "2026-04-12T11:00:00.000Z",
  }),
  mkMsg("msg-92", {
    channelId: "ch-8",
    authorId: "usr-5",
    text: "Down to 180kb gzipped.",
    createdAt: "2026-04-12T11:30:00.000Z",
  }),
  mkMsg("msg-93", {
    channelId: "ch-8",
    authorId: "usr-4",
    text: "Figma token plugin working with Tailwind v4.",
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-94", {
    channelId: "ch-8",
    authorId: "usr-5",
    text: "Can we sync on the empty state components?",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-95", {
    channelId: "ch-8",
  ...
  mkMsg("msg-99", {
    channelId: "ch-8",
    authorId: "usr-10",
    text: "Posting the meeting link in a bit.",
    createdAt: "2026-04-13T09:25:00.000Z",
  }),
  ...
  mkMsg("msg-100", {
    channelId: "ch-9",
    authorId: "usr-9",
    text: "Cluster scaling completed without incident.",
    createdAt: "2026-04-12T09:00:00.000Z",
  }),
  mkMsg("msg-101", {
    channelId: "ch-9",
    authorId: "usr-11",
    text: "IAM audit running.",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-102", {
    channelId: "ch-9",
    authorId: "usr-12",
    text: "Data pipeline SLA at 99.95% this week.",
    createdAt: "2026-04-12T11:00:00.000Z",
  }),
  mkMsg("msg-103", {
    channelId: "ch-9",
    authorId: "usr-14",
    text: "Backup verification OK.",
    createdAt: "2026-04-12T12:00:00.000Z",
  }),
  mkMsg("msg-104", {
    channelId: "ch-9",
    authorId: "usr-9",
    text: "Terraform state locked — don't apply until I unlock.",
    createdAt: "2026-04-13T08:30:00.000Z",
  }),
  mkMsg("msg-105", {
    channelId: "ch-9",
  ...
  mkMsg("msg-106", {
    channelId: "ch-9",
    authorId: "usr-14",
    text: "Vault rotation starting.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-107", {
    channelId: "ch-9",
    authorId: "usr-12",
    text: "DWH job failure at 03:00. Retried. OK now.",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  mkMsg("msg-108", {
    channelId: "ch-9",
  ...
  mkMsg("msg-110", {
    channelId: "ch-10",
    authorId: "usr-13",
    text: "New vendor NDA template v3 ready.",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-111", {
    channelId: "ch-10",
    authorId: "usr-1",
    text: "Thanks — will circulate to the team.",
    createdAt: "2026-04-12T10:15:00.000Z",
  }),
  mkMsg("msg-112", {
    channelId: "ch-10",
    authorId: "usr-8",
    text: "Compliance review for Q2 launch?",
    mentions: ["usr-13"],
    createdAt: "2026-04-13T08:00:00.000Z",
  }),
  mkMsg("msg-113", {
    channelId: "ch-10",
    authorId: "usr-13",
    text: "Scheduling this week.",
    createdAt: "2026-04-13T08:15:00.000Z",
  }),
  mkMsg("msg-114", {
    channelId: "ch-10",
    authorId: "usr-13",
    text: "Privacy policy update needed for new data pipeline.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-115", {
    channelId: "ch-10",
    authorId: "usr-1",
    text: "Drafting a note to send to everyone.",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  ...
  mkMsg("msg-116", {
    channelId: "ch-11",
    authorId: "usr-15",
    text: "How do I reset my VPN?",
    createdAt: "2026-04-13T08:00:00.000Z",
  }),
  mkMsg("msg-117", {
    channelId: "ch-11",
    authorId: "usr-14",
    text: "Go to it.theta.internal → VPN → reset token.",
  ...
  mkMsg("msg-119", {
    channelId: "ch-11",
    authorId: "usr-12",
    text: "Anyone know the grafana URL?",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-120", {
    channelId: "ch-11",
    authorId: "usr-9",
    text: "grafana.theta.internal",
    createdAt: "2026-04-13T09:05:00.000Z",
  }),
  mkMsg("msg-121", {
    channelId: "ch-11",
    authorId: "usr-5",
    text: "How do I install the new dev tools?",
    createdAt: "2026-04-13T10:00:00.000Z",
  }),
  mkMsg("msg-122", {
    channelId: "ch-11",
    authorId: "usr-2",
    text: "brew install theta-cli",
    createdAt: "2026-04-13T10:05:00.000Z",
  }),
  ...
  mkMsg("msg-123", {
    channelId: "ch-12",
    authorId: "usr-7",
    text: "INC-042: Payment gateway timeouts starting 14:32 IST.",
    createdAt: "2026-04-09T14:32:00.000Z",
  }),
  mkMsg("msg-124", {
    channelId: "ch-12",
    authorId: "usr-2",
    text: "Investigating. Elevated 5xx from payments service.",
    createdAt: "2026-04-09T14:34:00.000Z",
  }),
  mkMsg("msg-125", {
    channelId: "ch-12",
    authorId: "usr-9",
    text: "Upstream vendor reporting issues.",
    createdAt: "2026-04-09T14:40:00.000Z",
  }),
  mkMsg("msg-126", {
    channelId: "ch-12",
    authorId: "usr-2",
    text: "Circuit breaker enabled. Traffic dropping.",
    createdAt: "2026-04-09T14:50:00.000Z",
  }),
  mkMsg("msg-127", {
    channelId: "ch-12",
    authorId: "usr-7",
    text: "Vendor confirms resolved at their end.",
    createdAt: "2026-04-09T15:20:00.000Z",
  }),
  mkMsg("msg-128", {
    channelId: "ch-12",
    authorId: "usr-2",
    text: "Recovery confirmed. Closing incident.",
    createdAt: "2026-04-09T15:40:00.000Z",
    reactions: [
      {
        emoji: ":white_check_mark:",
        userIds: ["usr-1", "usr-7", "usr-9", "usr-14"],
      },
    ],
  }),
  mkMsg("msg-129", {
    channelId: "ch-12",
    authorId: "usr-7",
    text: "Postmortem doc: /docs/incidents/inc-042",
  ...
  mkMsg("msg-130", {
    channelId: "ch-12",
    authorId: "usr-11",
    text: "Action items tracked in #engineering.",
    createdAt: "2026-04-10T10:00:00.000Z",
  }),
  ...
  mkMsg("msg-131", {
    channelId: "ch-13",
    authorId: "usr-7",
    text: "Senior platform engineer role posted.",
    createdAt: "2026-04-11T09:00:00.000Z",
  }),
  mkMsg("msg-132", {
    channelId: "ch-13",
    authorId: "usr-8",
    text: "Have 3 strong referrals to share.",
    createdAt: "2026-04-11T10:00:00.000Z",
  }),
  mkMsg("msg-133", {
    channelId: "ch-13",
    authorId: "usr-1",
    text: "Interview panel for Friday: Priya, Arjun, Ravi.",
    createdAt: "2026-04-12T09:00:00.000Z",
  }),
  mkMsg("msg-134", {
    channelId: "ch-13",
  ...
  mkMsg("msg-135", {
    channelId: "ch-13",
    authorId: "usr-4",
    text: "Design interview Monday 10am.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  ...
  mkMsg("msg-136", {
    channelId: "ch-14",
    authorId: "usr-6",
    text: "Team offsite June 15-17, Goa. RSVP this week!",
    createdAt: "2026-04-12T10:00:00.000Z",
    reactions: [
      {
        emoji: ":beach_with_umbrella:",
        userIds: ["usr-1", "usr-2", "usr-4", "usr-5", "usr-8"],
      },
    ],
  }),
  mkMsg("msg-137", {
    channelId: "ch-14",
    authorId: "usr-8",
    text: "Birthday celebration for Kiran tomorrow at 4pm!",
    mentions: ["usr-5"],
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-138", {
  ...
  mkMsg("msg-139", {
    channelId: "ch-14",
    authorId: "usr-10",
    text: "Photos from last week's hackathon uploaded.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-140", {
    channelId: "ch-14",
    authorId: "usr-6",
    text: "Karaoke Friday confirmed — 7pm at Skyline.",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  mkMsg("msg-141", {
    channelId: "ch-14",
  ...
  mkMsg("msg-142", {
    channelId: "ch-15",
    authorId: "usr-1",
    text: "Board deck final draft attached.",
    createdAt: "2026-04-12T09:00:00.000Z",
  }),
  mkMsg("msg-143", {
    channelId: "ch-15",
    authorId: "usr-2",
    text: "Looks good, one comment on slide 14.",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-144", {
    channelId: "ch-15",
    authorId: "usr-7",
    text: "Comp review cycle kick-off next Monday.",
    createdAt: "2026-04-12T11:00:00.000Z",
  }),
  mkMsg("msg-145", {
    channelId: "ch-15",
    authorId: "usr-1",
    text: "Budget review Friday 11am.",
    createdAt: "2026-04-13T08:00:00.000Z",
  }),
  mkMsg("msg-146", {
    channelId: "ch-15",
    authorId: "usr-7",
    text: "Headcount plan in the works.",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-147", {
    channelId: "ch-15",
    authorId: "usr-2",
    text: "Strategy offsite dates confirmed: May 5-6.",
    createdAt: "2026-04-13T09:30:00.000Z",
  }),
  mkMsg("msg-148", {
    channelId: "ch-15",
    authorId: "usr-1",
    text: "Pinned: strategy notes doc /docs/strategy-h1",
    createdAt: "2026-04-13T10:00:00.000Z",
    pinnedBy: "usr-1",
  }),
  ...
  mkMsg("msg-150", {
    dmId: "dm-1",
    authorId: "usr-2",
    text: "Hey Priya, can you review the PLT-102 PR?",
    createdAt: "2026-04-13T09:00:00.000Z",
  }),
  mkMsg("msg-151", {
    dmId: "dm-1",
  ...
  mkMsg("msg-153", {
    dmId: "dm-1",
    authorId: "usr-2",
    text: "Thanks! I'll merge after CI.",
    createdAt: "2026-04-13T09:35:00.000Z",
  }),
  mkMsg("msg-154", {
    dmId: "dm-1",
  ...
  mkMsg("msg-157", {
    dmId: "dm-2",
    authorId: "usr-1",
    text: "Ravi, can you pick up PLT-103?",
    createdAt: "2026-04-12T16:00:00.000Z",
  }),
  mkMsg("msg-158", {
    dmId: "dm-2",
    authorId: "usr-3",
    text: "Yes, starting tomorrow.",
    createdAt: "2026-04-12T16:30:00.000Z",
  }),
  mkMsg("msg-159", {
    dmId: "dm-2",
    authorId: "usr-3",
    text: "Quick question — should the API be REST or gRPC?",
    createdAt: "2026-04-13T10:30:00.000Z",
  }),
  mkMsg("msg-160", {
    dmId: "dm-2",
    authorId: "usr-3",
    text: "Never mind, going with REST per the RFC.",
    createdAt: "2026-04-13T11:00:00.000Z",
  }),
  ...
  mkMsg("msg-161", {
    dmId: "dm-3",
    authorId: "usr-4",
    text: "Mocks ready for your review.",
    createdAt: "2026-04-12T15:00:00.000Z",
  }),
  mkMsg("msg-162", {
    dmId: "dm-3",
    authorId: "usr-1",
    text: "Looking now — great work.",
    createdAt: "2026-04-12T16:00:00.000Z",
  }),
  mkMsg("msg-163", {
    dmId: "dm-3",
  ...
  mkMsg("msg-164", {
    dmId: "dm-4",
    authorId: "usr-slackbot",
    text: "Hi Priya! Welcome to Theta HQ. I'm Slackbot — ask me anything!",
    createdAt: "2024-01-10T09:00:00.000Z",
  }),
  mkMsg("msg-165", {
    dmId: "dm-4",
    authorId: "usr-slackbot",
    text: "Tip: try pressing Cmd-K to quickly navigate the workspace.",
    createdAt: "2024-01-10T09:05:00.000Z",
  }),
  mkMsg("msg-166", {
    dmId: "dm-4",
    authorId: "usr-slackbot",
    text: "Reminder: team all-hands starts in 10 minutes.",
    createdAt: "2026-04-12T09:50:00.000Z",
  }),
  mkMsg("msg-167", {
    dmId: "dm-4",
    authorId: "usr-slackbot",
    text: "Daily digest: 3 mentions, 2 DMs, 1 thread reply.",
    createdAt: "2026-04-13T08:00:00.000Z",
  }),
  mkMsg("msg-168", {
    dmId: "dm-4",
    authorId: "usr-slackbot",
    text: "You have 1 scheduled message going out tomorrow.",
    createdAt: "2026-04-13T08:05:00.000Z",
  }),
  ...
  mkMsg("msg-169", {
    dmId: "dm-5",
    authorId: "usr-2",
    text: "Hey Kiran, can you review the CSS tokens?",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-170", {
    dmId: "dm-5",
    authorId: "usr-5",
    text: "Yes, reviewing now.",
    createdAt: "2026-04-12T11:00:00.000Z",
  }),
  mkMsg("msg-171", {
    dmId: "dm-5",
    authorId: "usr-5",
    text: "LGTM, small naming suggestion.",
    createdAt: "2026-04-12T12:00:00.000Z",
  }),
  mkMsg("msg-172", {
    dmId: "dm-5",
    authorId: "usr-2",
    text: "Accepted, merging.",
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-173", {
    dmId: "dm-5",
  ...
  mkMsg("msg-174", {
    dmId: "dm-6",
    authorId: "usr-1",
    text: "Platform team weekly sync prep",
    createdAt: "2026-04-13T08:30:00.000Z",
  }),
  mkMsg("msg-175", {
    dmId: "dm-6",
    authorId: "usr-2",
    text: "Agenda draft: 1) RFC 2) oncall 3) Q2 plan",
    createdAt: "2026-04-13T08:35:00.000Z",
  }),
  mkMsg("msg-176", {
    dmId: "dm-6",
    authorId: "usr-3",
    text: "Add: session API RFC review",
  ...
  mkMsg("msg-182", {
    dmId: "dm-7",
    authorId: "usr-8",
    text: "Design ↔ PM sync notes from this morning",
    createdAt: "2026-04-12T10:00:00.000Z",
  }),
  mkMsg("msg-183", {
    dmId: "dm-7",
  ...
  mkMsg("msg-184", {
    dmId: "dm-7",
    authorId: "usr-6",
    text: "I'll incorporate feedback this week.",
    createdAt: "2026-04-12T12:00:00.000Z",
  }),
  mkMsg("msg-185", {
    dmId: "dm-7",
    authorId: "usr-1",
    text: "Great — looking forward to the updated mocks.",
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-186", {
    dmId: "dm-7",
    authorId: "usr-8",
    text: "Let's sync again Thursday.",
    createdAt: "2026-04-12T16:00:00.000Z",
  }),
  ...
  mkMsg("msg-187", {
    dmId: "dm-8",
    authorId: "usr-7",
    text: "Infra ↔ platform capacity planning",
    createdAt: "2026-04-12T13:00:00.000Z",
  }),
  mkMsg("msg-188", {
    dmId: "dm-8",
    authorId: "usr-9",
    text: "Drafted a doc — sharing link.",
    createdAt: "2026-04-12T14:00:00.000Z",
  }),
  mkMsg("msg-189", {
    dmId: "dm-8",
    authorId: "usr-1",
    text: "Great, will review this afternoon.",
    createdAt: "2026-04-12T15:00:00.000Z",
  }),
  ...
  mkMsg("msg-190", {
    channelId: "ch-1",
    authorId: "usr-1",
    text: "Good morning team — happy Tuesday!",
...
// Update thread reply counts based on actual replies
{
  ...
  for (const root of messages) {
    ...
    root.threadParticipantIds = Array.from(
      new Set(replies.map((r) => r.authorId))
    )
  }
}
...
export const savedItems: SavedItem[] = [
  ...
  },
  {
    ...
    userId: "usr-1",
    messageId: "msg-129",
    reminder: "2026-04-15T10:00:00.000Z",
    createdAt: "2026-04-10T09:00:00.000Z",
    isCompleted: false,
  },
  {
...
export const bookmarks: Bookmark[] = [
  {
    ...
    url: "https://github.com/theta/platform",
    emoji: ":octocat:",
    createdBy: "usr-2",
    createdAt: "2024-03-01T10:00:00.000Z",
  },
  {
    id: "bk-2",
    channelId: "ch-4",
    title: "Linear — PLT board",
    url: "https://linear.theta.internal/team/PLT",
    emoji: ":kanban:",
    createdBy: "usr-2",
  ...
  },
  {
    ...
    channelId: "ch-4",
    title: "Runbook",
    url: "https://runbooks.theta.internal/oncall",
    emoji: ":book:",
    createdBy: "usr-1",
  ...
  },
  {
    ...
    channelId: "ch-5",
    title: "Notion — brand",
    url: "https://notion.so/theta/brand",
    emoji: ":notebook:",
    createdBy: "usr-4",
    ...
    items: [
      {
        id: "li-1",
        values: {
          "f-title": "Fix race condition in auth service",
      ...
      },
      {
        id: "li-2",
        values: {
          "f-title": "Add rate limiting metrics",
          "f-status": "todo",
          "f-assignee": "usr-3",
          "f-due": "2026-04-20",
        },
      },
      {
        id: "li-3",
        values: {
          "f-title": "Vault token rotation script",
          "f-status": "done",
          "f-assignee": "usr-14",
          "f-due": "2026-04-12",
        },
...
export const callHistory: Call[] = [
  ...
  },
  {
    ...
    endedAt: "2026-04-11T14:30:00.000Z",
    participantIds: ["usr-1", "usr-2"],
    channelId: null,
    dmId: "dm-1",
  },
  {
    ...
    endedAt: "2026-04-10T10:20:00.000Z",
    participantIds: ["usr-4", "usr-6", "usr-8"],
    channelId: "ch-5",
    dmId: null,
  },
  {
    ...
    endedAt: "2026-04-09T15:40:00.000Z",
    participantIds: ["usr-1", "usr-2", "usr-7", "usr-9"],
    channelId: "ch-12",
    dmId: null,
  },
]
