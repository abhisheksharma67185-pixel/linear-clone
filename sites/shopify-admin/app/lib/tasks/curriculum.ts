  ...
  const stages: CurriculumStage[] = [
    {
      ...
      description: "Navigate between admin pages and identify page content",
      domains: ["navigation"],
    ...
    },
    {
      ...
      description: "Create new products, customers, and discounts",
    ...
    },
    {
      ...
      description: "Fulfill orders, capture payments, issue refunds, add notes",
      domains: ["orders"],
    ...
    },
    {
      ...
      description: "Find specific data using search, filters, and calculation",
    ...
    },
    {
      ...
      description: "Tasks requiring inspection before action, multi-entity operations",
    ...
    },
    {
      ...
      description: "Impossible tasks, multi-step workflows in one domain",
    ...
    },
    {
      ...
      description: "Tasks spanning products, orders, customers, and discounts",
    ...
    },
    {
      ...
      description: "Complex real-world merchant scenarios with multiple objectives",
      domains: ["multi-domain"],
