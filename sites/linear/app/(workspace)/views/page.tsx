...
function ViewIconPicker() {
  return (
    <IconPickerPopover
      trigger={
        // Linear's "Views" mark — stacked-layers glyph (top rhombus +
        // wavy bottom layer). Kept in sync with the `ViewsIcon` used by
        // the sidebar Views entry so the row icon and the nav entry stay
        // visually consistent.
        <svg
