...
//
// NOTE on isolation: per-session site state is isolated, but the SimEngine's
// active episode is process-wide. Run one rollout at a time per Next.js
// process, or shard rollouts across processes. Per-session episode tracking
// is on the roadmap.
