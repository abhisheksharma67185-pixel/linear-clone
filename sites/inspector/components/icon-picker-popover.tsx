      ...
      <PopoverTrigger
        render={
          <button
            ...
            className={
              triggerClassName ??
              // `data-[popup-open]:bg-accent` keeps the trigger visually
              // anchored to the open popover (Linear convention) — without
              // it the button drops back to its idle state the moment the
              // pointer leaves on the way to the popover content, which
              // makes the picker feel disconnected from its row.
              "hover:bg-accent data-[popup-open]:bg-accent data-[popup-open]:text-foreground flex size-5 shrink-0 items-center justify-center rounded"
            }
          />
        }
      >
