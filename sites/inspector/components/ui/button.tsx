...
type ButtonOwnProps = ButtonPrimitive.Props &
  VariantProps<typeof buttonVariants> & {
    /**
     * If true and a single React element child is provided, render that
     * element instead of a `<button>`. Mirrors Radix's `asChild` semantics
     * by forwarding to base-ui's `render` prop.
     */
    asChild?: boolean
  }
